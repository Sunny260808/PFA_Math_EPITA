...
/*Integrate functions*/
extern double integrate_trap(double (*f)(double), double a, double b, double dx);

extern double integrate_simp(double (*f)(double), double a, double b, double dx);

extern double integrate_inter2(double (*f)(double), double a, double b, double dx);

extern double integrate_inter3(double (*f)(double), double a, double b, double dx);
